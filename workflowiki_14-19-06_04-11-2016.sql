...
INSERT INTO `activities` VALUES (1,2,'Decide what to eat','','2016-11-02 14:34:47','2016-11-02 14:34:47'),(2,1,'Take loaf out','','2016-11-02 22:34:52','2016-11-02 22:34:52'),(3,1,'Cut some slices of bread','','2016-11-03 00:38:51','2016-11-03 00:38:51'),(4,1,'Get peanut butter','','2016-11-03 00:40:11','2016-11-03 00:40:11'),(5,1,'Spread peanut butter on toast','','2016-11-03 00:40:31','2016-11-03 00:40:31'),(6,1,'Eat food','','2016-11-03 00:45:01','2016-11-03 00:45:01'),(7,1,'Get ingredients','','2016-11-03 00:45:27','2016-11-03 00:45:27'),(8,1,'Get pan','','2016-11-03 00:46:06','2016-11-03 00:46:06'),(9,1,'Put ingredients in pan and cook','','2016-11-03 00:46:33','2016-11-03 00:46:33'),(10,1,'Get bowl','','2016-11-03 00:46:58','2016-11-03 00:46:58'),(11,1,'Pour cooked porridge into bowl','','2016-11-03 00:47:23','2016-11-03 00:47:23');
...
INSERT INTO `events` VALUES (1,1,'It starts with hunger.','','2016-11-02 14:34:36','2016-11-02 14:34:36');
/*!40000 ALTER TABLE `events` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `gate_options`
--

DROP TABLE IF EXISTS `gate_options`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `gate_options`
--

LOCK TABLES `gate_options` WRITE;
/*!40000 ALTER TABLE `gate_options` DISABLE KEYS */;
INSERT INTO `gate_options` VALUES (1,1,'Toast','2016-11-02 14:46:36','2016-11-02 14:46:36'),(2,1,'Porridge','2016-11-02 16:38:00','2016-11-02 16:38:00');
/*!40000 ALTER TABLE `gate_options` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `gates` VALUES (1,2,'2016-11-02 14:46:36','2016-11-02 14:46:36');
...
INSERT INTO `migrations` VALUES ('2014_10_12_000000_create_users_table',1),('2014_10_12_100000_create_password_resets_table',1),('2016_10_05_105706_create_workflows_table',1),('2016_10_07_013617_create_steps_table',1),('2016_10_07_065428_create_tasks_table',1),('2016_10_13_032602_create_variables_table',1),('2016_10_28_002207_create_processes_table',2),('2016_10_28_050030_create_nodes_table',3),('2016_10_28_051607_create_events_table',3),('2016_10_28_092346_create_activities_table',3),('2016_10_31_105127_create_gates_table',3),('2016_10_31_110105_create_gate_options_table',3);
...
CREATE TABLE `nodes` (
  ...
  `nodeable_id` int(10) unsigned NOT NULL,
  `nodeable_type` varchar(64) COLLATE utf8_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `nodes` VALUES (1,1,0,1,1,'App\\Event','2016-11-02 14:34:36','2016-11-02 22:20:31'),(2,1,0,2,1,'App\\Activity','2016-11-02 14:34:47','2016-11-02 22:20:31'),(3,1,0,3,1,'App\\Gate','2016-11-02 14:46:36','2016-11-02 22:20:31'),(4,1,1,1,2,'App\\Activity','2016-11-02 22:34:52','2016-11-02 22:34:52'),(5,1,1,2,3,'App\\Activity','2016-11-03 00:38:51','2016-11-03 00:38:51'),(6,1,1,3,4,'App\\Activity','2016-11-03 00:40:11','2016-11-03 00:40:11'),(7,1,1,4,5,'App\\Activity','2016-11-03 00:40:31','2016-11-03 00:40:31'),(8,1,1,5,6,'App\\Activity','2016-11-03 00:45:01','2016-11-03 00:45:01'),(9,1,2,1,7,'App\\Activity','2016-11-03 00:45:27','2016-11-03 00:45:27'),(10,1,2,2,8,'App\\Activity','2016-11-03 00:46:06','2016-11-03 00:46:06'),(11,1,2,3,9,'App\\Activity','2016-11-03 00:46:33','2016-11-03 00:46:33'),(12,1,2,4,10,'App\\Activity','2016-11-03 00:46:58','2016-11-03 00:46:58'),(13,1,2,5,11,'App\\Activity','2016-11-03 00:47:23','2016-11-03 00:47:23');
...
INSERT INTO `processes` VALUES (1,1,'My breakfast process','This is my breakfast process with I\'m home.','2016-10-29 00:23:10','2016-10-29 00:23:10'),(2,1,'Creating a process on workflowiki','I\'m using workflowiki to document how a process is created.','2016-10-29 00:33:04','2016-10-29 00:33:04'),(3,1,'Test process alpha','Testing alpha description.','2016-10-29 14:07:30','2016-10-29 14:07:30');
...
INSERT INTO `users` VALUES (1,'Peter Reginald','peter@reginald.com.au','$2y$10$E0akuZkDW41.E7ODmdI76ujpSWdW0qtX4U9ioJfW6zwAuuTi2DOR6','gFC9TMT522OsABD9mjwmgymTV1vmC9Ta77USwwHma9ZkX1tJUZlByOMscdpp',NULL,'2016-10-28 23:21:42'),(2,'James Dean','james@dean.com','$2y$10$CY5ixU9RjsI.Lt8dpcMsd.oatyOfyyfYAA9EwjizL04Pdrfm/NMQ6','FlDtapTsok17sHZSlQNzeqhxkyJU4bmDXa2YMptDlnV1dVJn0bQ6LbuJu6CJ',NULL,'2016-10-17 16:04:31');
...
-- Dump completed on 2016-11-04 14:19:07
